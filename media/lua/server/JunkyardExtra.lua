...
function hcjunksearchlarge(items, result, player)
    ...
    elseif metal == 19 then
        player:getInventory():AddItem("Base.HCToywagon");
    elseif metal == 18 then
